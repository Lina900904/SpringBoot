...
@MapperScan(basePackages="com.mexico.demo.mapper")
@ComponentScan(basePackages="com.mexico.demo")
public class DataBaseConfig {
	...
	public SqlSessionFactory sqlSessionFactory(DataSource ds) throws Exception {
		...
		sf.setMapperLocations(rs.getResources("classpath:com/mexico/demo/mapper/*.xml"));
		return sf.getObject();
